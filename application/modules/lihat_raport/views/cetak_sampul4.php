...
<body>
	<table>
		<tr>
			<td width="10%">
			<img src="<?php echo base_url(); ?>aset/img/logo-tut.png" style="margin-top: 10px; width: 90px; height: 80px">
			</td>
			<td style="text-align: center"><b>KEMENTERIAN PENDIDIKAN REPUBLIK INDONESIA<br>
			SEKOLAH DASAR NEGERI 11 RANTAU BAYUR<br></b>
			<span style="font-size: 10pt">Alamat :Jalan Desa Dusun I, Sungai Pinang, Rantau Bayur, Banyuasin. <br>
			Telp : 0813 6742 9217 | Web : http://sdn11raba.sch.id/</span>
			</td>
		</tr>
	...
	<div style="margin-left: 120px; display: inline; float: left;">
		Sungai Pinang, <?php echo tjs($ds['diterima_tgl'],"l"); ?><br>
		Kepala Sekolah<br>
		<br>
		<br>
		<br>
		<br>
		<b><u>Darlis, S.Pd. SD</u></b><br>
		NIP. 19690627 200103 1 001
	</div>
