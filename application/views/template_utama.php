...
<head>
	...
	<title>E-Raport SDN 11 Rantau Bayur</title>
        ...
        <nav class="navbar navbar-default navbar-fixed " >
            <div class="container-fluid">
                <div class="navbar-header ">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url(); ?>"><i class="pe-7s-notebook"></i> E-Raport SDN 11 Rantau Bayur</a>
                </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    Waktu proses {elapsed_time} detik. &copy; 2023-<?=date('M-D')?> | By Mahyudin
                </p>
            </div>
        </footer>
